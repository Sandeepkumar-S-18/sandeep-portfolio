  ...
  return (
    <section id="contact" className="section-padding">
      <div className="max-w-3xl mx-auto" ref={ref}>
        ...
        >
          <h2 className="font-mono text-sm text-primary mb-2 tracking-wider">06. Contact</h2>
        ...
        >
          ...
          <div className="space-y-4">
            {[
              { icon: Mail, label: "tech.sandeep18@gmail.com", href: "mailto:tech.sandeep18@gmail.com" },
              { icon: Phone, label: "+91 8123571317", href: "tel:+918123571317" },
              { icon: Github, label: "GitHub", href: "https://github.com/Sandeepkumar-S-18" },
              { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/sandeepku-s" },
